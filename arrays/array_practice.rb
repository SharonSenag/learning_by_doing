...
puts "The second from last element is #{number_3[8]}"
...
puts "If we delete 5, 6 and 7 from the array, we're left with [#{number_3.take(4).join(",")},#{number_3.pop(3).join(",")}]"

# "If we add 5 at the beginning of the array, we're left with [5,1,2,3,4,8,9,10]"
puts "If we add 5 at the beginning of the array, we're left with [#{number_3.unshift(5).take(5).push(8,9,10).join(",")}]"

# "If we add 6 at the end of the array, we're left with [5,1,2,3,4,8,9,10,6]"
puts "If we add 6 at the end of the array, we're left with [#{number_3.take(5).push(8,9,10,6).join(",")}]"
