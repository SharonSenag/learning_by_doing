...
puts "That means when you turn #{my_age_now}, you've been alive for #{seconds_in_a_minute * minutes_in_an_hour * hours_in_a_day * days_in_a_year * my_age_now} seconds,"
puts "and if you make it to #{my_age_later}, you will have lived #{seconds_in_a_minute * minutes_in_an_hour * hours_in_a_day * days_in_a_year * my_age_later} seconds.  Make them count!"
